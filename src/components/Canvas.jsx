    ...
    <main className="flex-1 overflow-y-scroll px-12">
      <div className="my-12 bg-white">
        <nav className="flex items-center justify-between px-12 py-6">
          <img src="../img/logo.png" alt="logo" className="h-11 w-11" />
          <div className="flex gap-x-6">
            <button className="rounded-full bg-blue-600 py-3 px-8 text-white">
              Hire Us
            </button>
            <button className="p-2">
              <FiMenu className="h-6 w-6 stroke-current text-gray-9 00" />
            </button>
          </div>
        </nav>
        <section className="py-16 px-12">
          <div className="group relative">
            <div className="absolute inset-0 pointer-events-none hidden border-2 border-blue-600 group-focus-within:block">
              <div className="absolute -translate-y-full pl-2">
                <div className="flex items-center gap-x-2 bg-blue-600 text-white px-3 py-1 rounded-t-lg">
                  ...
                  <HiOutlinePencil className="h-4 w-4 stroke-current " />
                </div>
              </div>
              <div className="absolute left-0 top-0 h-2 w-2 -translate-x-full -translate-y-full border-2 border-blue-600" />
              <div className="absolute right-0 top-0 h-2 w-2 translate-x-full -translate-y-full border-2 border-blue-600" />
              <div className="absolute right-0 bottom-0 h-2 w-2 translate-x-full translate-y-full border-2 border-blue-600" />
              <div className="absolute left-0 bottom-0 h-2 w-2 -translate-x-full translate-y-full border-2 border-blue-600" />
